    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', borderBottomWidth: 0.5 }}>
                <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Favorurite</Text>
            </View>
            ...
            {/* View -  3*/}
            <View style={{ flex: 1, borderTopWidth: 1, justifyContent: 'center', alignItems: 'center' }}>
                <TouchableOpacity style={{ backgroundColor: '#53B175', width: '90%', height: '90%', borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
...
const renderItem = ({ item }) => (
    < View style={{ width: '100%', height: 110, flexDirection: 'row', borderBottomWidth: 0.5, marginBottom: 10 }}>
        ...
        <View style={{ width: '40%', height: '100%', paddingLeft: 20, justifyContent: 'center' }}>
            <Text style={{ fontWeight: 'bold', fontSize: 18 }}>Sprite Can</Text>
            <Text style={{ fontSize: 16, color: 'grey' }}>2L / Price</Text>
        </View>

        <View style={{ width: '30%', height: '100%', justifyContent: 'center', alignItems: 'center' }}>
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontWeight: 'bold', fontSize: 18, paddingRight: 10 }}>50.000 đ</Text>
                <TouchableOpacity>
